...
<ul>
    ...
    <li><strong>Training:</strong> The model was trained for 50 epochs with a 640x640 image resolution and a batch size of 16 using the Ultralytics YOLOv8 framework.</li>
    <li><strong>Evaluation:</strong> The model achieved high precision and recall for Fillings and Implants (e.g., Implant precision: 0.93, mAP50: 0.97). Cavity detection performance was lower due to class imbalance and the subtle appearance of cavities in X-rays.</li>
    <li><strong>Deployment:</strong> A basic inference setup allows users to upload an image and view predictions with bounding boxes and class labels. This is a simulation intended for educational purposes and is not meant for clinical use.</li>
    <li><strong>Limitations:</strong> Small or faint anomalies like cavities remain challenging to detect accurately. Enhancements such as better annotations, higher-resolution images, and data rebalancing could improve results.</li>
    <li><strong>Future Work:</strong> Planned improvements include expanding the dataset, using larger YOLOv8 model variants, and exploring real-time use cases in dental education or diagnostics support.</li>
</ul>

<img src="example1.jpg" alt="X-ray Example 1" width="600" height="400">
<img src="example2.jpg" alt="X-ray Example 2" width="600" height="400">
...
<a href="https://www.youtube.com/watch?v=dGsDyyeznKE" target="_blank"><img src="https://img.youtube.com/vi/dGsDyyeznKE/0.jpg" alt="YouTube Video Preview" style="width: 560px; height: 315px; border: 1px solid #ccc;"></a>
...
<a href="https://www.youtube.com/watch?v=KJ54NI7sPEw" target="_blank"><img src="https://img.youtube.com/vi/KJ54NI7sPEw/0.jpg" alt="YouTube Video Preview" style="width: 560px; height: 315px; border: 1px solid #ccc;"></a>
...
<a href="https://www.youtube.com/watch?v=JyQ6_NoLaJM" target="_blank"><img src="https://img.youtube.com/vi/JyQ6_NoLaJM/0.jpg" alt="YouTube Video Preview" style="width: 560px; height: 315px; border: 1px solid #ccc;"></a>
...
<a href="https://www.youtube.com/watch?v=Id5PRPIkJAI" target="_blank"><img src="https://img.youtube.com/vi/Id5PRPIkJAI/0.jpg" alt="YouTube Video Preview" style="width: 560px; height: 315px; border: 1px solid #ccc;"></a>
...
<a href="https://www.youtube.com/watch?v=aB5QlNL5TWs" target="_blank"><img src="https://img.youtube.com/vi/aB5QlNL5TWs/0.jpg" alt="YouTube Video Preview" style="width: 560px; height: 315px; border: 1px solid #ccc;"></a>
